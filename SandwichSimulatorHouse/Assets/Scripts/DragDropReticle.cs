...
/* Modifying original GvrReticle script to incorporate drag and drop.
 * Did not want to change the original script so I copied it.
 */
...
public class DragDropReticle : MonoBehaviour, IGvrGazePointer {
	...
	// create a reference for what object viewer is looking at
	...
	public void OnGazeStart(Camera camera, GameObject targetObject, Vector3 intersectionPosition,
		...
		// Set gazeAt to targetObject since we are looking at it now
	...
	public void OnGazeExit(Camera camera, GameObject targetObject) {
		...
		// Set gazeAt to null again since we are not looking at
		// the target option anymore
		gazedAt = null;
	}
	...
	public void OnGazeTriggerStart(Camera camera) {
		...
		ExecuteEvents.Execute(gazedAt, null, (DragDropHandler handler, BaseEventData data) => handler.StartHandleGazeTrigger());
	}
	...
	public void OnGazeTriggerEnd(Camera camera) {
		...
		ExecuteEvents.Execute(gazedAt, null, (DragDropHandler handler, BaseEventData data) => handler.StopHandleGazeTrigger());
	}
